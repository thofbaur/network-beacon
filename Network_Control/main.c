...
#define TIME_SUSCEPT	14400 //4h
#define TIME_RECOVER	18000
#define TIME_INFECT		300
#define TIME_HEAL		180
#define	TIME_EXPOSED_ALT	2700  //45 min
#define INF_REV			1
...
//		P_CHANGE_STATUS		, STATUS_S														, 0, // Set first param die desired status
